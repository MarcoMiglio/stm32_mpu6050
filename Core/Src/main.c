...
uint8_t mot_th = 10;    // Suggested value ~ 20mg
uint8_t mot_dur = 2;    // The "old" documentation suggests duration = 1 ms


/****** ZERO MOTION DETECTION THRESHOLDS ******/
uint8_t zeroMot_th  = 60;    // 1 LSB = 2 mg
uint8_t zeroMot_dur = 150;      // 1 LSB = 64 ms
...
uint8_t acel_deadzone = 8;  // Average accel. value should be less than this threshold
uint8_t gyro_deadzone = 1;  // Average gyro values should be less than this threshold
...
// Function prototype for printf redirection:
